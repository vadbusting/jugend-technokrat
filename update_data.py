...
def main():
    ...
    new_added = 0
    for p in reversed(rss_prods):  # reverse so oldest RSS items get processed first, newest end up at the very top
        p_id = p['id']
    ...
    if new_added > 0:
        ...
        print("Successfully updated database and CSV catalogs.")
    else:
        print("No new products found in RSS. Database is up to date.")
